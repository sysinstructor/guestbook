        ...
        stage('Checkout') {
            steps {
                ...
                dir('/root/sub-workspace/guestbook-config'){
                    git branch: 'master', url:'https://github.com/sysinstructor/guestbook-config.git'
                }
            }
        }
            ...
            steps {
                dir('/root/sub-workspace/guestbook-config'){
                    sh '''
                        ...
                        git push "https://sysinstructor:${GITHUB_ACCESS_TOKEN}@github.com/sysinstructor/guestbook-config.git"
                    '''
                }
            }
        }
            ...
            steps {
                sh '''
                    ...
                    curl -v -k -XPOST \
                        ...
                        https://192.168.11.200/api/v1/applications/guestbook/sync
                '''
            }
        }
    }
